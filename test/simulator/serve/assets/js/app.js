...
(function (global, factory) {
            ...
            function generateStore(t){var e=t.pluginName,n=(new Date).getTime();return {namespaced:!0,state:{pluginName:e,name:t.name||"App-"+n,alias:t.alias||"app-"+n,version:t.version||"0.0.0",platform:t.platform,settings:t.settings||{}},getters:{pluginName:function(t){return t.pluginName},name:function(t){return t.name},alias:function(t){return t.alias},version:function(t){return t.version},platform:function(t){return t.platform},settings:function(t){return t.settings}},actions:{setName:function(t,e){t.commit("setAppName",e);},setAlias:function(t,e){t.commit("setAppAlias",e);},setVersion:function(t,e){t.commit("setAppVersion",e);},setPlatform:function(t,e){t.commit("setAppPlatform",e);},setSettings:function(t,e){t.commit("setAppSettings",e);}},mutations:{setAppName:function(t,e){t.appName=e;},setAppAlias:function(t,e){t.appAlias=e;},setAppVersion:function(t,e){t.appVersion=e;},setAppPlatform:function(t,e){t.appPlatform=e;},setAppSettings:function(t,e){t.settings=e;}}}}var _extends=Object.assign||function(t){
            var arguments$1 = arguments;
            for(var e=1;e<arguments.length;e++){var n=arguments$1[e];for(var i in n){ Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i]); }}return t},pluginName="client-app-config",defaultNamespace="app";function install(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=e.logInit&&!0===e.logInit,i=e.namespace||defaultNamespace,a=e.config||{},s=e.settings||{};if(n&&console.log('Vue is being bootstrapped with "'+pluginName+'"'),e.store){var o=generateStore(_extends({pluginName:pluginName,settings:s},a));e.store.registerModule(i,o);}}var plugin=install;
              ...
              render: function render (h) {
                ...
                if (this.tag === 'a') {
                  ...
                  if (a) {
                    ...
                    for (var event$1 in on$$1) {
                      if (event$1 in aData.on) {
                        // on[event] is always a function
                        aData.on[event$1].push(on$$1[event$1]);
                      } else {
            ...
            var script = {
              ...
              computed: {
                appPlatform: function appPlatform() {
                  return this.$store.getters['app/platform'];
                },
                appName: function appName() {
                  return this.$store.getters['app/name'];
                },
                appAlias: function appAlias() {
                  return this.$store.getters['app/alias'];
                },
                appVersion: function appVersion() {
                  return this.$store.getters['app/version'];
                },
              },
            ...
            var __vue_render__ = function() {
              ...
              return _c("div", [
                _c("div", { staticClass: "app-platform" }, [
                  _vm._v(_vm._s(_vm.appPlatform))
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "app-name" }, [_vm._v(_vm._s(_vm.appName))]),
                _vm._v(" "),
                _c("div", { staticClass: "app-alias" }, [
                  _vm._v("(" + _vm._s(_vm.appAlias) + ")")
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "app-version" }, [_vm._v(_vm._s(_vm.appVersion))])
              ])
            };
            ...
            __vue_render__._withStripped = true;
              ...
              var __vue_inject_styles__ = function (inject) {
                if (!inject) { return }
                inject("data-v-6c8e36bf_0", { source: "\n.app-platform[data-v-6c8e36bf] {\n  color: #999999;\n  font-size: 18px;\n  font-style: italic;\n  text-align: center;\n  margin: 30px auto 10px auto;\n}\n.app-name[data-v-6c8e36bf] {\n  color: #121212;\n  font-size: 30px;\n  text-align: center;\n  margin: 0 auto 10px auto;\n}\n.app-alias[data-v-6c8e36bf] {\n  color: #121212;\n  font-size: 18px;\n  text-align: center;\n  margin: 10px auto 10px auto;\n}\n.app-version[data-v-6c8e36bf] {\n  color: #525252;\n  font-size: 16px;\n  font-style: italic;\n  text-align: center;\n  margin: 0 auto 10px auto;\n}\n\n\n", map: {"version":3,"sources":["/Users/wmccraw/git_repos/manic_manifesto/vuestrap-client-app-config/test/simulator/pages/HomePage.vue"],"names":[],"mappings":";AAyCA;EACA,cAAA;EACA,eAAA;EACA,kBAAA;EACA,kBAAA;EACA,2BAAA;AACA;AACA;EACA,cAAA;EACA,eAAA;EACA,kBAAA;EACA,wBAAA;AACA;AACA;EACA,cAAA;EACA,eAAA;EACA,kBAAA;EACA,2BAAA;AACA;AACA;EACA,cAAA;EACA,eAAA;EACA,kBAAA;EACA,kBAAA;EACA,wBAAA;AACA","file":"HomePage.vue","sourcesContent":["<template>\n  <div>\n\n    <div class=\"app-platform\">{{ appPlatform }}</div>\n    <div class=\"app-name\">{{ appName }}</div>\n    <div class=\"app-alias\">({{ appAlias }})</div>\n    <div class=\"app-version\">{{ appVersion }}</div>\n\n  </div>\n</template>\n\n<script>\n\nexport default {\n  name: 'HomePage',\n\n  components: {\n  },\n\n  computed: {\n    appPlatform() {\n      return this.$store.getters['app/platform'];\n    },\n    appName() {\n      return this.$store.getters['app/name'];\n    },\n    appAlias() {\n      return this.$store.getters['app/alias'];\n    },\n    appVersion() {\n      return this.$store.getters['app/version'];\n    },\n  },\n\n  methods: {\n  },\n};\n</script>\n\n<style scoped>\n\n  .app-platform {\n    color: #999999;\n    font-size: 18px;\n    font-style: italic;\n    text-align: center;\n    margin: 30px auto 10px auto;\n  }\n  .app-name {\n    color: #121212;\n    font-size: 30px;\n    text-align: center;\n    margin: 0 auto 10px auto;\n  }\n  .app-alias {\n    color: #121212;\n    font-size: 18px;\n    text-align: center;\n    margin: 10px auto 10px auto;\n  }\n  .app-version {\n    color: #525252;\n    font-size: 16px;\n    font-style: italic;\n    text-align: center;\n    margin: 0 auto 10px auto;\n  }\n\n\n</style>\n"]}, media: undefined });

              };
              /* scoped */
              var __vue_scope_id__ = "data-v-6c8e36bf";
              /* module identifier */
              ...
              var HomePage = normalizeComponent_1(
            ...
            var __vue_staticRenderFns__$1 = [
              function() {
                ...
                var _h = _vm.$createElement;
                var _c = _vm._self._c || _h;
                return _c("div", { staticClass: "page-message" }, [
                  _vm._v("\n  This page is public.\n  "),
                  _c("br"),
                  _c("br"),
                  _vm._v(
            ...
            __vue_render__$1._withStripped = true;
              ...
              var __vue_inject_styles__$1 = function (inject) {
                if (!inject) { return }
                inject("data-v-99844df2_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"PublicPage.vue"}, media: undefined });

              };
              /* scoped */
              var __vue_scope_id__$1 = "data-v-99844df2";
              /* module identifier */
              ...
              var PublicPage = normalizeComponent_1(
            ...
            __vue_render__$2._withStripped = true;
              ...
              var __vue_inject_styles__$2 = function (inject) {
                if (!inject) { return }
                inject("data-v-90e22dea_0", { source: "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", map: {"version":3,"sources":[],"names":[],"mappings":"","file":"PrivatePage.vue"}, media: undefined });

              };
              /* scoped */
              var __vue_scope_id__$2 = "data-v-90e22dea";
              /* module identifier */
              ...
              var PrivatePage = normalizeComponent_1(
            ...
            var script$3 = {
              ...
              methods: {
                generateNavItemClasses: function generateNavItemClasses(routeName) {
              ...
              return _c(
                ...
                [
                  _c("router-link", { attrs: { to: { name: "home" } } }, [
                    _c("div", { class: _vm.generateNavItemClasses("home") }, [
                      _c("span", [_vm._v("Home Page")])
                    ])
                  ]),
                  _vm._v(" "),
                  _c("router-link", { attrs: { to: { name: "public" } } }, [
                    _c("div", { class: _vm.generateNavItemClasses("public") }, [
                      _c("span", [_vm._v("Public Page")])
                    ])
                  ]),
                  _vm._v(" "),
                  _c("router-link", { attrs: { to: { name: "private" } } }, [
                    _c(
                      "div",
                      { class: _vm.generateNavItemClasses("private"), attrs: { flat: "" } },
                      [_c("span", [_vm._v("Private Page")])]
                    )
                  ])
                ],
                1
            ...
            __vue_render__$3._withStripped = true;
              ...
              var __vue_inject_styles__$3 = function (inject) {
                if (!inject) { return }
                inject("data-v-6e38593f_0", { source: "\n.app-navigation[data-v-6e38593f] {\n  border-top: 1px solid #c9c9c9;\n  border-bottom: 1px solid #c9c9c9;\n  background-color: #e9e9e9;\n}\n.nav-item[data-v-6e38593f] {\n  display: inline-block;\n  font-weight: 500;\n  text-transform: none;\n  padding: 6px 15px;\n}\n.selected-nav-item[data-v-6e38593f] {\n  color: #111111;\n  background-color: #cfcfcf;\n}\n\n", map: {"version":3,"sources":["/Users/wmccraw/git_repos/manic_manifesto/vuestrap-client-app-config/test/simulator/components/AppNavigation.vue"],"names":[],"mappings":";AAwCA;EACA,6BAAA;EACA,gCAAA;EACA,yBAAA;AACA;AAEA;EACA,qBAAA;EACA,gBAAA;EACA,oBAAA;EACA,iBAAA;AACA;AACA;EACA,cAAA;EACA,yBAAA;AACA","file":"AppNavigation.vue","sourcesContent":["<template>\n  <div class=\"app-navigation\">\n\n    <router-link v-bind:to=\"{ name: 'home' }\">\n      <div v-bind:class=\"generateNavItemClasses('home')\">\n        <span>Home Page</span>\n      </div>\n    </router-link>\n\n    <router-link v-bind:to=\"{ name: 'public' }\">\n      <div v-bind:class=\"generateNavItemClasses('public')\">\n        <span>Public Page</span>\n      </div>\n    </router-link>\n\n    <router-link v-bind:to=\"{ name: 'private' }\">\n      <div flat v-bind:class=\"generateNavItemClasses('private')\">\n        <span>Private Page</span>\n      </div>\n    </router-link>\n\n  </div>\n</template>\n\n<script>\nexport default {\n  name: 'AppNavigation',\n\n  methods: {\n    generateNavItemClasses(routeName) {\n      return (this.$route.name === routeName)\n        ? 'nav-item selected-nav-item'\n        : 'nav-item';\n    },\n  },\n};\n</script>\n\n<style scoped>\n\n  .app-navigation {\n    border-top: 1px solid #c9c9c9;\n    border-bottom: 1px solid #c9c9c9;\n    background-color: #e9e9e9;\n  }\n\n  .nav-item {\n    display: inline-block;\n    font-weight: 500;\n    text-transform: none;\n    padding: 6px 15px;\n  }\n  .selected-nav-item {\n    color: #111111;\n    background-color: #cfcfcf;\n  }\n\n</style>\n"]}, media: undefined });

              };
              /* scoped */
              var __vue_scope_id__$3 = "data-v-6e38593f";
              /* module identifier */
            ...
            var script$4 = {
              ...
              computed: {
                pluginName: function pluginName() {
                  return this.$store.getters['app/pluginName'];
                },
              },
              ...
              return _c(
                ...
                [
                  _c("div", { staticClass: "app-header" }, [
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "plugin-name" }, [
            ...
            __vue_render__$4._withStripped = true;
              ...
              var __vue_inject_styles__$4 = function (inject) {
                if (!inject) { return }
                inject("data-v-c729c684_0", { source: "\nbody {\n    font-size: 14px;\n    color: #252525;\n    background-color: #f9f9f9;\n    margin: 0;\n}\n#app {\n    font-family: 'Avenir', Helvetica, Arial, sans-serif;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n    text-align: center;\n}\na {\n    color: #676767;\n    cursor: pointer;\n    text-decoration: none;\n}\na:hover {\n    color: #111111;\n}\n.clear {\n    clear: both;\n}\n.app-header {\n    text-align: left;\n    padding: 10px 30px;\n}\n.app-header > div {\n    display: inline-block;\n}\n.app-header .title {\n    font-size: 20px;\n    font-weight: 500;\n    border-right: 1px solid #dedede;\n    padding-right: 30px;\n}\n.app-header .plugin-name {\n    margin-left: 20px;\n    font-size: 17px;\n}\n.app-header .controls {\n    float: right;\n}\n.btn-logout {\n    font-size: 15px;\n    border: 1px solid #e2e2e2;\n    border-radius: 4px;\n    padding: 2px 9px;\n    cursor: pointer;\n}\n.btn-logout:hover {\n    background-color: #d9d9d9;\n    border: 1px solid #d9d9d9;\n}\n.page {\n    margin-top: 20px;\n    padding: 40px;\n}\n.page-message {\n    font-size: 18px;\n}\n\n/* -----------------------------------------------------------------------------\n * Component Transitions\n * -------------------------------------------------------------------------- */\n\n  /* -----------------------------------------------------  fade-slow (2 sec) */\n.fade-slow-enter-active,\n  .fade-slow-leave-active {\n    transition: opacity 2s;\n}\n.fade-slow-enter,\n  .fade-slow-leave-to {\n    opacity: 0;\n}\n\n  /* ----------------------------------------------------------  fade (1 sec) */\n.fade-enter-active,\n  .fade-leave-active {\n    transition: opacity 1s;\n}\n.fade-enter,\n  .fade-leave-to {\n    opacity: 0;\n}\n\n  /* ---------------------------------------------------  fade-fast (0.5 sec) */\n.fade-fast-enter-active,\n  .fade-fast-leave-active {\n    transition: opacity 0.5s;\n}\n.fade-fast-enter,\n  .fade-fast-leave-to {\n    opacity: 0;\n}\n\n  /* -------------------------------------------------  fade-flash (0.25 sec) */\n.fade-flash-enter-active,\n  .fade-flash-leave-active {\n    transition: opacity 0.25s;\n}\n.fade-flash-enter,\n  .fade-flash-leave-to {\n    opacity: 0;\n}\n\n", map: {"version":3,"sources":["/Users/wmccraw/git_repos/manic_manifesto/vuestrap-client-app-config/test/simulator/pages/App.vue"],"names":[],"mappings":";AA4CA;IACA,eAAA;IACA,cAAA;IACA,yBAAA;IACA,SAAA;AACA;AAEA;IACA,mDAAA;IACA,mCAAA;IACA,kCAAA;IACA,kBAAA;AACA;AAEA;IACA,cAAA;IACA,eAAA;IACA,qBAAA;AACA;AACA;IACA,cAAA;AACA;AAEA;IACA,WAAA;AACA;AAEA;IACA,gBAAA;IACA,kBAAA;AACA;AACA;IACA,qBAAA;AACA;AACA;IACA,eAAA;IACA,gBAAA;IACA,+BAAA;IACA,mBAAA;AACA;AACA;IACA,iBAAA;IACA,eAAA;AACA;AACA;IACA,YAAA;AACA;AAEA;IACA,eAAA;IACA,yBAAA;IACA,kBAAA;IACA,gBAAA;IACA,eAAA;AACA;AACA;IACA,yBAAA;IACA,yBAAA;AACA;AAEA;IACA,gBAAA;IACA,aAAA;AACA;AACA;IACA,eAAA;AACA;;AAEA;;+EAEA;;EAEA,6EAAA;AACA;;IAEA,sBAAA;AACA;AACA;;IAEA,UAAA;AACA;;EAEA,6EAAA;AACA;;IAEA,sBAAA;AACA;AACA;;IAEA,UAAA;AACA;;EAEA,6EAAA;AACA;;IAEA,wBAAA;AACA;AACA;;IAEA,UAAA;AACA;;EAEA,6EAAA;AACA;;IAEA,yBAAA;AACA;AACA;;IAEA,UAAA;AACA","file":"App.vue","sourcesContent":["<template>\n  <div id=\"app\">\n    <div class=\"app-header\">\n      <div class=\"title\">\n        Vuestrap Testing\n      </div>\n      <div class=\"plugin-name\">\n        {{ pluginName }}\n      </div>\n      <div class=\"controls\"></div>\n      <div class=\"clear\" />\n    </div>\n\n    <app-navigation />\n\n    <transition name=\"fade-fast\" mode=\"out-in\">\n      <router-view class=\"page\"></router-view>\n    </transition>\n  </div>\n</template>\n\n<script>\nimport AppNavigation from '../components/AppNavigation.vue';\n\nexport default {\n  name: 'App',\n\n  components: {\n    AppNavigation,\n  },\n\n  computed: {\n    pluginName() {\n      return this.$store.getters['app/pluginName'];\n    },\n  },\n\n  methods: {\n  },\n}\n</script>\n\n<style>\n\n  body {\n    font-size: 14px;\n    color: #252525;\n    background-color: #f9f9f9;\n    margin: 0;\n  }\n\n  #app {\n    font-family: 'Avenir', Helvetica, Arial, sans-serif;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n    text-align: center;\n  }\n\n  a {\n    color: #676767;\n    cursor: pointer;\n    text-decoration: none;\n  }\n  a:hover {\n    color: #111111;\n  }\n\n  .clear {\n    clear: both;\n  }\n\n  .app-header {\n    text-align: left;\n    padding: 10px 30px;\n  }\n  .app-header > div {\n    display: inline-block;\n  }\n  .app-header .title {\n    font-size: 20px;\n    font-weight: 500;\n    border-right: 1px solid #dedede;\n    padding-right: 30px;\n  }\n  .app-header .plugin-name {\n    margin-left: 20px;\n    font-size: 17px;\n  }\n  .app-header .controls {\n    float: right;\n  }\n\n  .btn-logout {\n    font-size: 15px;\n    border: 1px solid #e2e2e2;\n    border-radius: 4px;\n    padding: 2px 9px;\n    cursor: pointer;\n  }\n  .btn-logout:hover {\n    background-color: #d9d9d9;\n    border: 1px solid #d9d9d9;\n  }\n\n  .page {\n    margin-top: 20px;\n    padding: 40px;\n  }\n  .page-message {\n    font-size: 18px;\n  }\n\n/* -----------------------------------------------------------------------------\n * Component Transitions\n * -------------------------------------------------------------------------- */\n\n  /* -----------------------------------------------------  fade-slow (2 sec) */\n  .fade-slow-enter-active,\n  .fade-slow-leave-active {\n    transition: opacity 2s;\n  }\n  .fade-slow-enter,\n  .fade-slow-leave-to {\n    opacity: 0;\n  }\n\n  /* ----------------------------------------------------------  fade (1 sec) */\n  .fade-enter-active,\n  .fade-leave-active {\n    transition: opacity 1s;\n  }\n  .fade-enter,\n  .fade-leave-to {\n    opacity: 0;\n  }\n\n  /* ---------------------------------------------------  fade-fast (0.5 sec) */\n  .fade-fast-enter-active,\n  .fade-fast-leave-active {\n    transition: opacity 0.5s;\n  }\n  .fade-fast-enter,\n  .fade-fast-leave-to {\n    opacity: 0;\n  }\n\n  /* -------------------------------------------------  fade-flash (0.25 sec) */\n  .fade-flash-enter-active,\n  .fade-flash-leave-active {\n    transition: opacity 0.25s;\n  }\n  .fade-flash-enter,\n  .fade-flash-leave-to {\n    opacity: 0;\n  }\n\n</style>\n"]}, media: undefined });
